Imports DamProverModel.DAMProverEntities
...
Namespace Data.ProviderModel
    Public MustInherit Class DataProvider(Of TElement)
        ...
        'Public Sub New(ByVal key As String, ByVal name As String, ByVal source As String, ByVal parameters As Dictionary(Of String, Object))
        Public Sub New()
            '_name = name
            '_key = key
        ...
        Public ReadOnly Property Parameters() As Dictionary(Of String, Object) Implements IDataProvider.Parameters
            Get
                Return _parameters
            End Get
        End Property
        ...
        Private _dicCache As New Dictionary(Of String, IEnumerable(Of Object))
        ...
        Private Function GetExistingKeyInCache(params As Dictionary(Of String, Object)) As Dictionary(Of String, Object)
            Dim k
        ...
        Private Function GetDataFromCache(params As Dictionary(Of String, Object)) As IEnumerable(Of TElement)
