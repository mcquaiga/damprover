Public Class SuperFactorClass
    ...
    Private Sub CalcFPV()
        ...
        If (tau >= 1.09 And tau <= 1.4 And pi >= 0 And pi <= 2) Then
            E = 1 - 0.00075 * pi ^ 2.3 * Math.Exp(-20 * (tau - 1.09)) - 0.0011 * Math.Sqrt(tau - 1.09) * pi * pi * (2.17 + 1.4 * Math.Sqrt(tau - 1.09) - pi) ^ 2
        Else
            ...
            Else
                If (tau >= 0.88 And tau <= 1.09 And pi >= 1.3 And pi <= 2.0!) Then
                    E = 1 - 0.00075 * pi ^ 2.3 * (2 - Math.Exp(-20 * (1.09 - tau))) + 0.455 * (200 * (1.09 - tau) ^ 6 - 0.03249 * (1.09 - tau) + 2.0167 * (1.09 - tau) ^ 2 - 18.028 * (1.09 - tau) ^ 3 + 42.844 * (1.09 - tau) ^ 4) * (pi - 1.3) * (1.69 * 2 ^ 1.25 - pi * pi)
                Else
                    If (tau >= 0.84 And tau <= 0.88 And pi >= 1.3 And pi <= 2.0!) Then
                        S = 1.25 + 80 * (0.88 - tau) ^ 2
                        E = 1 - 0.00075 * pi ^ 2.3 * (2 - Math.Exp(-20 * (1.09 - tau))) + 0.455 * (200 * (1.09 - tau) ^ 6 - 0.03249 * (1.09 - tau) + 2.0167 * (1.09 - tau) ^ 2 - 18.028 * (1.09 - tau) ^ 3 + 42.844 * (1.09 - tau) ^ 4) * (pi - 1.3) * (1.69 * 2 ^ S - pi * pi)
                    Else
                        If (Me.GaugeTemp >= 85 And Me.GaugeTemp <= 240 And Me.GaugePressure >= 0 And Me.GaugePressure <= 2000) Then
                            E = 1 - 0.00075 * pi ^ 2.3 * Math.Exp(-20 * (tau - 1.09)) - 0.0011 * Math.Sqrt(tau - 1.09) * pi * pi * (2.17 + 1.4 * Math.Sqrt(tau - 1.09) - pi) ^ 2
                        Else
                            If (Me.GaugeTemp >= -40 And Me.GaugeTemp <= 85 And Me.GaugePressure >= 0 And Me.GaugePressure <= 1300) Then
                                E = 1 - 0.00075 * pi ^ 2.3 * (2 - Math.Exp(-20 * (1.09 - tau))) - 1.317 * (1.09 - tau) ^ 4 * pi * (1.69 - pi * pi)
                            Else
                                If (Me.GaugeTemp >= -20 And Me.GaugeTemp <= 85 And Me.GaugePressure >= 1300 And Me.GaugePressure <= 2000) Then
                                    E = 1 - 0.00075 * pi ^ 2.3 * (2 - Math.Exp(-20 * (1.09 - tau))) + 0.455 * (200 * (1.09 - tau) ^ 6 - 0.03249 * (1.09 - tau) + 2.0167 * (1.09 - tau) ^ 2 - 18.028 * (1.09 - tau) ^ 3 + 42.844 * (1.09 - tau) ^ 4) * (pi - 1.3) * (1.69 * 2 ^ 1.25 - pi * pi)
                                Else
                                    If (Me.GaugeTemp >= -40 And Me.GaugeTemp <= -20 And Me.GaugePressure >= 1300 And Me.GaugePressure <= 2000) Then
                                        S = 1.25 + 80 * (0.88 - tau) ^ 2
                                        E = 1 - 0.00075 * pi ^ 2.3 * (2 - Math.Exp(-20 * (1.09 - tau))) + 0.455 * (200 * (1.09 - tau) ^ 6 - 0.03249 * (1.09 - tau) + 2.0167 * (1.09 - tau) ^ 2 - 18.028 * (1.09 - tau) ^ 3 + 42.844 * (1.09 - tau) ^ 4) * (pi - 1.3) * (1.69 * 2 ^ S - pi * pi)
                                    End If
                                End If
